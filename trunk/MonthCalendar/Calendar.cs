...
namespace MonthCalendar
{
	...
	public class Calendar: Control		
    {
        ...
        private Button m_TodayButton = null;
		...
		public Calendar() {
            ...
            this.Controls.Add(m_TodayButton);
        ...
        private void DrawExtend(PaintEventArgs e)
        {
            if (m_HeaderStyle.Visible == true)
            {
                if (m_ViewMode == ViewMode.vmMonth)
                {
                    if (m_OKButton.Visible != m_HeaderStyle.ShowNav)
                        m_OKButton.Visible = m_HeaderStyle.ShowNav;

                    int iTextHeight = m_HeaderStyle.Font.Height;
                    int iLeftPosNextButton = this.Width - m_NextButton.Width - m_HeaderStyle.Padding.Horizontal - m_NextYearButton.Width - 1;

                    m_OKButton.SetBounds(iLeftPosNextButton, this.Height - 26, 36, 22);
                }
                else
                {
                    if (m_OKButton.Visible != false)
        ...
        private void DrawHeader(PaintEventArgs e)
        {
            if (m_HeaderStyle.Visible == true)
            {
                ...
                if (m_ViewMode == ViewMode.vmMonth)
                {
                    if (m_PreviousYearButton.Visible != m_HeaderStyle.ShowNav)
                        m_PreviousYearButton.Visible = m_HeaderStyle.ShowNav;
                ...
                if (m_ViewMode == ViewMode.vmMonth)
                {
                    ...
                    iLeftPosNextButton = this.Width - m_NextButton.Width - m_HeaderStyle.Padding.Horizontal - m_NextYearButton.Width - 1;
                }
                else
                {
                ...
                if (HeaderRender != null)
                    HeaderRender(this, myHeaderRenderEvent);

                if (myHeaderRenderEvent.OwnerDraw == false)
                {
                    m_NextButton.SetBounds(iLeftPosNextButton, m_NextTopPos + ((int)(myRectangle.Height - 18) / 2), 18, 18);
                    if (m_NextButton.Visible != m_HeaderStyle.ShowNav)
                        m_NextButton.Visible = m_HeaderStyle.ShowNav;
        ...
        protected override void OnLostFocus(EventArgs e)
        {
            ...
            if(    m_NextButton.Focused
                || m_PreviousButton.Focused
                || m_NextButton.Focused
                || m_PreviousYearButton.Focused
                || m_NextYearButton.Focused
                || m_OKButton.Focused
                || m_TodayButton.Focused
                )
            {
                return;
            }
        ...
        protected override void OnMouseUp(MouseEventArgs e)
        {
            switch (m_ViewMode)
            {
                ...
                case ViewMode.vmYear:
                    ...
                    {
                        m_MouseInWeekDay = false;
                        int DateMaxNum = DateTime.DaysInMonth(m_SelectedDate.Year, m_SelectedMonthIndex+1);
                        DateTime myNewDate = new DateTime(m_SelectedDate.Year, m_SelectedMonthIndex + 1, (m_SelectedDate.Day > DateMaxNum ? DateMaxNum : m_SelectedDate.Day));
        ...
        private void OKClick(object sender, EventArgs e)
        {
            ...
            {
                if (SelectDay != null)
                    SelectDay(this, new SelectDayEventArgs(m_SelectedDate));
            }
        }
        ...
        private void TodayClick(object sender, EventArgs e)
        {
            ...
            {
                case ViewMode.vm120Years:
                    SetViewMode(ViewMode.vmMonth, ViewMode.vm120Years);
                    break;
                case ViewMode.vm12Years:
                    SetViewMode(ViewMode.vmMonth, ViewMode.vm12Years);
                    break;
                case ViewMode.vmYear:
                    SetViewMode(ViewMode.vmMonth, ViewMode.vmYear);
                    break;
            ...
            if (CanSelectDate(myDT) == true)
            {
                ...
                if (myCanChangeMonthEvent.Cancel == false)
                {
                    if (MonthChanged != null)
                        MonthChanged(this, new ChangeMonthEventArgs(m_SelectedDate));
                    int CurrentDateNum = DateTime.DaysInMonth(myDT.Year, myDT.Month);
                    SelectedDate = new DateTime(myDT.Year, myDT.Month, (m_SelectedDate.Day > CurrentDateNum ? CurrentDateNum : m_SelectedDate.Day));
                }
            }
        }
                    ...
                    if (e.KeyCode == m_KeyboardControl.Select)
                    {
                        switch (m_ViewMode)
                        {
                            ...
                            case ViewMode.vmYear:
                                ...
                                int DateMaxNum = DateTime.DaysInMonth(m_SelectedDate.Year, iSelectedIndex + 1);
                                myNewDate = new DateTime(m_SelectedDate.Year, iSelectedIndex + 1, (m_SelectedDate.Day > DateMaxNum ? DateMaxNum : m_SelectedDate.Day));
                                if (m_SelectionMode != SelectionMode.smNone)
                                {
                                    SelectedDate = myNewDate;
                                }
